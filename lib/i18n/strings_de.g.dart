...
class _TranslationsSettingsDeveloperDe extends TranslationsSettingsDeveloperEn {
  ...
  String get performanceOverlayDescription =>
      'Display FPS and frame timing information';
  @override
  ...
  String get restartTutorialDescription =>
      'Reset flags and launch tutorial again';
  @override
  ...
  String get throwExceptionDescription =>
      'Trigger a test exception for crash reporting';
  @override
  ...
  String get hideOptionsDescription =>
      'Disable developer mode (requires 7 taps to re-enable)';
  @override
  ...
  String get storageInspectorDescription =>
      'View Hive & Secure Storage contents';
  @override
...
class _TranslationsSettingsSettingsViewDe
  ...
  String get importContent =>
      'This will replace all your current settings with the imported ones. This action cannot be undone.';
  @override
  ...
  dynamic _flatMapFunction(String path) {
    return switch (path) {
          ...
          'settings.developer.deviceEnvironmentDescription' =>
            'Screen, platform, and build info',
          ...
          'settings.developer.featureFlags.flags.new_diff_algorithm.description' =>
            'Use improved diffing algorithm for comparisons',
          ...
          'settings.developer.featureFlags.flags.enhanced_search.description' =>
            'Enable fuzzy search in translation files',
        ...
        switch (path) {
          ...
          'settings.settingsView.resetCategoryTitle' =>
            ({required Object category}) => 'Reset ${category}?',
          ...
          'settings.settingsView.resetSuccess' =>
            ({required Object category}) => '${category} reset to defaults',
          ...
          'settings.settingsView.updateAvailable' =>
            ({required Object version}) => 'Update available: v${version}',
